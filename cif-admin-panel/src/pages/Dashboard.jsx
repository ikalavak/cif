...
// Real collections used across this project — matches Events.jsx,
// Categories.jsx, Gallery.jsx.
const COLLECTIONS = [
  "events",
  "categories",
  "gallery",
...
export default function Dashboard() {
  ...
  // Simple live filter across events by title — matches the "Global Search" box
  const searchResults = (() => {
    ...
    <div>
      ...
      >
        ...
        <div className="muted" style={{ fontSize: 12, marginBottom: 10 }}>
          Search across events, categories, and job applications.
        </div>
        <input
