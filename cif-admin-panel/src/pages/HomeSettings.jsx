...
export default function HomeSettings() {
  ...
  const [formData, setFormData] = useState({
    ...
    cta_text: 'Explore the programme, save your favourite events and connect with the creative community.',
    cta_button_text: 'Explore Events',
    highlights: [
      { id: '1', icon: 'briefcase', title: 'Careers', text: 'Meet employers and get CV and portfolio advice.' },
      { id: '2', icon: 'scissors', title: 'Fashion', text: 'Explore creative fashion design and sustainable fashion-tech.' },
      { id: '3', icon: 'film', title: 'Screen', text: 'Learn how to break into film and television.' },
      { id: '4', icon: 'users', title: 'Networking', text: 'Connect with creatives, businesses and industry professionals.' },
    ],
  });
  ...
  const handleHeroImageUpload = (e) => {
    ...
    const storagePath = `site_assets/hero_banner_${Date.now()}.${fileExt}`;
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p className="muted">Manage mobile app hero banners, about details, and interactive highlight vector icons.</p>
      ...
      <form onSubmit={handleSave}>
        ...
        <div style={{ background: '#f8fafc', padding: 20, borderRadius: 10, marginBottom: 24, border: '1px solid #e2e8f0' }}>
          ...
          <div style={{ marginBottom: 12 }}>
            <label style={{ display: 'block', fontWeight: 600, fontSize: 13, marginBottom: 4 }}>Hero Badge</label>
            <input
              type="text"
          ...
          <div style={{ marginBottom: 12 }}>
            <label style={{ display: 'block', fontWeight: 600, fontSize: 13, marginBottom: 4 }}>Hero Title</label>
            <input
              type="text"
              className="search-input"
          ...
          <div style={{ marginBottom: 12 }}>
            <label style={{ display: 'block', fontWeight: 600, fontSize: 13, marginBottom: 4 }}>Hero Subtitle</label>
            <input
              type="text"
              className="search-input"
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
            <div>
              <label style={{ display: 'block', fontWeight: 600, fontSize: 13, marginBottom: 4 }}>Dates Display</label>
              <input
                type="text"
                className="search-input"
                value={formData.hero_dates}
                onChange={(e) => setFormData({ ...formData, hero_dates: e.target.value })}
                style={{ width: '100%' }}
              />
            </div>
            <div>
              <label style={{ display: 'block', fontWeight: 600, fontSize: 13, marginBottom: 4 }}>Location Display</label>
              <input
                type="text"
                className="search-input"
                value={formData.hero_locations}
                onChange={(e) => setFormData({ ...formData, hero_locations: e.target.value })}
                style={{ width: '100%' }}
              />
            </div>
          </div>

          {/* HERO IMAGE UPLOADER WITH BUTTON, URL, & LIVE PREVIEW */}
          <div style={{ background: '#ffffff', padding: 18, borderRadius: 10, border: '1px solid #cbd5e1' }}>
            ...
            <div style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              >
                ...
                {heroUploading ? `Uploading (${heroUploadProgress}%)` : 'Upload Image'}
              </button>
        ...
        <div style={{ background: '#f8fafc', padding: 20, borderRadius: 10, marginBottom: 24, border: '1px solid #e2e8f0' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
            ...
            <button type="button" className="btn-secondary" onClick={addHighlight} style={{ fontSize: 12 }}>
              + Add Highlight
            </button>
          </div>
          ...
          {formData.highlights.map((hl, index) => (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                <span style={{ fontWeight: 700, fontSize: 13 }}>Highlight #{index + 1}</span>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '170px 1fr 2fr', gap: 12, alignItems: 'start' }}>
                <div>
                  ...
                  <IconPicker
                    value={hl.icon || 'star'}
                    onChange={(newIcon) => handleHighlightChange(index, 'icon', newIcon)}
                  />
                </div>
        ...
        <div style={{ background: '#f8fafc', padding: 20, borderRadius: 10, marginBottom: 24, border: '1px solid #e2e8f0' }}>
          ...
          <div style={{ marginBottom: 12 }}>
            <label style={{ display: 'block', fontWeight: 600, fontSize: 13, marginBottom: 4 }}>CTA Title</label>
            <input
              type="text"
              className="search-input"
          ...
          <div style={{ marginBottom: 12 }}>
            <label style={{ display: 'block', fontWeight: 600, fontSize: 13, marginBottom: 4 }}>CTA Text</label>
            <textarea
              rows={2}
              className="search-input"
          ...
          <div>
            <label style={{ display: 'block', fontWeight: 600, fontSize: 13, marginBottom: 4 }}>Button Text</label>
            <input
              type="text"
              className="search-input"
        ...
        <button type="submit" className="btn-primary" disabled={saving || heroUploading}>
